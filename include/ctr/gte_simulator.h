...
force_inline void _gte_mvmva(u8 doShift, const s16 (*matrix)[3], /* s16[3][3] */
                             ...
                             u8 doClamp)
{
	...
	/* row 0 */
	{
		s64 acc = (s64)cvx * 0x1000 + (s64)matrix[0][0] * vx + (s64)matrix[0][1] * vy + (s64)matrix[0][2] * vz;
	...
	/* row 1 */
	{
		s64 acc = (s64)cvy * 0x1000 + (s64)matrix[1][0] * vx + (s64)matrix[1][1] * vy + (s64)matrix[1][2] * vz;
		acc >>= shift;
		gte.MAC2 = (s32)acc;
	...
	/* row 2 */
	{
		s64 acc = (s64)cvz * 0x1000 + (s64)matrix[2][0] * vx + (s64)matrix[2][1] * vy + (s64)matrix[2][2] * vz;
		acc >>= shift;
		gte.MAC3 = (s32)acc;
...
#define gte_mvmva(sf_, mx_, v_, cv_, lm_)                                         \
	...
	{                                                                             \
		...
		{                                                                         \
		case GTE_MATRIX_ROT:                                                      \
			mx_p_ = gte.GTE_MATRIX_ROT;                                           \
			break;                                                                \
		case GTE_MATRIX_LIGHT:                                                    \
			mx_p_ = gte.GTE_MATRIX_LIGHT;                                         \
			break;                                                                \
		case GTE_MATRIX_COLOR:                                                    \
			mx_p_ = gte.GTE_MATRIX_COLOR;                                         \
			break;                                                                \
		default:                                                                  \
			mx_p_ = _gte_zero_mx_;                                                \
			break;                                                                \
		...
		{                                                                         \
		case GTE_VECTOR_0:                                                        \
			v_p_ = &gte.GTE_VECTOR_0;                                             \
			break;                                                                \
		case GTE_VECTOR_1:                                                        \
			v_p_ = &gte.GTE_VECTOR_1;                                             \
			break;                                                                \
		case GTE_VECTOR_2:                                                        \
			v_p_ = &gte.GTE_VECTOR_2;                                             \
			break;                                                                \
		case GTE_VECTOR_IR:                                                       \
			v_p_ = &gte.GTE_VECTOR_IR;                                            \
			break;                                                                \
		default:                                                                  \
			v_p_ = &_gte_zero_svec_;                                              \
			break;                                                                \
		}                                                                         \
                                                                                  \
		/* translation (Vec3) */                                                  \
		...
		switch ((int)(cv_))                                                       \
		{                                                                         \
		case GTE_TRANS_TRANSLATION:                                               \
			cv_p_ = &gte.GTE_TRANS_TRANSLATION;                                   \
			break;                                                                \
		case GTE_TRANS_BG_COLOR:                                                  \
			cv_p_ = &gte.GTE_TRANS_BG_COLOR;                                      \
			break;                                                                \
		case GTE_TRANS_FAR_COLOR:                                                 \
			cv_p_ = &gte.GTE_TRANS_FAR_COLOR;                                     \
			break;                                                                \
		default:                                                                  \
			cv_p_ = &_gte_zero_vec_;                                              \
			break;                                                                \
		}                                                                         \
                                                                                  \
