...
#define setXY4CompilerHack(p, s0, t0, s1, t1, s2, t2, s3, t3) \
	*(u_int *)&p->x0 = s0 | (t0 << 16), *(u_int *)&p->x1 = s1 | (t1 << 16), *(u_int *)&p->x2 = s2 | (t2 << 16), *(u_int *)&p->x3 = s3 | (t3 << 16)
...
#define setInt32RGB0(p, color0) *(u_int *)&p->r0 = color0

#define setInt32RGB4(p, color0, color1, color2, color3) \
	*(u_int *)&p->r0 = color0, *(u_int *)&p->r1 = color1, *(u_int *)&p->r2 = color2, *(u_int *)&p->r3 = color3
