	...
	do
	{
		...
		if (*str != '\r')
		{
			...
			while (1)
			{
				...
				lineLen = DECOMP_DecalFont_GetLineWidthStrlen(str, (u32)currPointer - (u32)str, (int)fontType);
		...
		if (!(flags & 0x800))
#endif
			DECOMP_DecalFont_DrawLineStrlen(str, (u32)strPointer - (u32)str, (int)posX, posY + totalPassageHeight, (int)fontType, (int)flags);
