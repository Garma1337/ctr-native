...
void (*funcs[NUM_STATES])() = {StatePS1_Launch_EnterPID,      StatePS1_Launch_PickServer,   StatePS1_Launch_PickRoom,      StatePS1_Launch_Error,
                               StatePS1_Lobby_AssignRole,     StatePS1_Lobby_HostTrackPick, StatePS1_Lobby_GuestTrackWait, StatePS1_Lobby_CharacterPick,
                               StatePS1_Lobby_WaitForLoading, StatePS1_Lobby_StartLoading,  StatePS1_Game_WaitForRace,     StatePS1_Game_StartRace,
...
// which can force in-game with 8000c000=LOBBY_START_LOADING
	...
	if (octr->boolClientBusy)
	{
		DecalFont_DrawLine("SEE CLIENT WINDOW", 0x100, 0x80, FONT_SMALL, JUSTIFY_CENTER | PAPU_YELLOW);
	}
