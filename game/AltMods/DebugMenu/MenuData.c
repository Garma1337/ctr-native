...
{
	int removeBits = ~(ADVENTURE_MODE | ADVENTURE_ARENA | TIME_TRIAL | BATTLE_MODE | ARCADE_MODE);
...
struct DebugRow rowsDbgBattle[] = {
    {3, 0x12, sdata_static.s_battle1, DebugMenu_LoadGame_GivenLevelId}, {3, 0x13, sdata_static.s_battle2, DebugMenu_LoadGame_GivenLevelId},
    {3, 0x14, sdata_static.s_battle3, DebugMenu_LoadGame_GivenLevelId}, {3, 0x15, sdata_static.s_battle4, DebugMenu_LoadGame_GivenLevelId},
    {3, 0x16, sdata_static.s_battle5, DebugMenu_LoadGame_GivenLevelId}, {3, 0x17, sdata_static.s_battle6, DebugMenu_LoadGame_GivenLevelId},
    {3, 0x18, sdata_static.s_battle7, DebugMenu_LoadGame_GivenLevelId}, {3, 0x10, sdata_static.s_secret1, DebugMenu_LoadGame_GivenLevelId},
    {3, 0x11, sdata_static.s_secret2, DebugMenu_LoadGame_GivenLevelId}, {0}};
...
struct DebugRow rowsDbgLevels[] = {{1, 0x0, "BATTLE...", &menuDbgBattle},
...
struct DebugRow rowsDbgChar[] = {{3, 0x0, "CRASH", DebugMenu_LoadGame_GivenCharacterId},
...
struct DebugRow rowsDbgPlayer[] = {{3, 0x1, "1", DebugMenu_LoadGame_GivenNumPlyr},
...
struct DebugRow rowsDbgMain[] = {{1, 0x0, "LEVEL...", &menuDbgLevels}, {1, 0x0, "PLAYERS...", &menuDbgPlayer}, {0}};
