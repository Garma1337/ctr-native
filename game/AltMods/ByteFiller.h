...
#define REP(thousands, hundreds, tens, ones, x) REP##thousands(REP16(REP16(REP16(x)))) REP##hundreds(REP16(REP16(x))) REP##tens(REP16(x)) REP##ones(x)
...
#define ONES_REP(ones, x) ONES_REP##ones(x)
